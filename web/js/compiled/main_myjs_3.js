$(document).ready(function () {
    ...
    //PICTURE MANAGEMENT FRONTEND FUNCTIONNALITY
    if(!($('div#gb_tricksbundle_trick_pictures_list').length === 0)) {
    ...
    //VIDEO MANAGEMENT FRONTEND FUNCTIONNALITY
    if(!($('div#gb_tricksbundle_trick_videos_list').length === 0)) {

...
class TrickController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('GBTricksBundle:Trick:index.html.twig', array('tricks' => $tricks, 'page' => $page, 'nextPage' => $nextPage,
    ...
    public function viewAction(Request $request, Trick $trick)
    {
        ...
        $messages = $messageRepository->findBy(array('trick' => $trick), array('date' => 'desc'), $this->getParameter('comments_per_page') * $page);
        $nextPage = $page + 1;
        ...
        return $this->render('GBTricksBundle:Trick:view.html.twig', array('trick' => $trick, 'form' => $form->createView(),

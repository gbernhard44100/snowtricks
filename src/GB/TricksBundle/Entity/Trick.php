...
class Trick
{
    ...
    /**
     *
     * @ORM\OneToMany(targetEntity="GB\TricksBundle\Entity\Message",
     * mappedBy="trick")
     */
    private $messages;
    
    /**
     * @ORM\OneToMany(targetEntity="GB\TricksBundle\Entity\Picture",
     * mappedBy="trick")
     */
    private $pictures;
    
    /**
     * @ORM\OneToMany(targetEntity="GB\TricksBundle\Entity\Video",
     * mappedBy="trick")
     */
    private $videos;

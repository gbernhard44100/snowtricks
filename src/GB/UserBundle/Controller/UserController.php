...
class UserController extends Controller
{
    ...
    public function forgotAction(Request $request)
    {
        ...
        return $this->render('GBUserBundle:User:forgot.html.twig', 
                array('form' => $form->createView()));
    }
    ...
    public function resetPasswordAction(Request $request) 
    {
        ...
        return $this->render('GBUserBundle:User:reset.html.twig', 
                array('user' => $user));        
    }
    ...
    public function showAction() {
        ...
        return $this->render('GBUserBundle:User:profil.html.twig', 
                array('user' => $user));
    }
